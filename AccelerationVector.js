 ...
 */
//===============================================================================
define (["Acceleration"], function(Acceleration) {

function AccelerationVector() {
	if (arguments.length == 0) {	//nothing
		this.base = null;
		this.x = null;
		this.y = null;
		this.z = null;
	} else if (arguments.length == 1) { // AccelerationVector
...
AccelerationVector.VectorTypeConstructorSurrogate = function (v) {
	return new AccelerationVector(v);
};

AccelerationVector.getVectorName = function() {
