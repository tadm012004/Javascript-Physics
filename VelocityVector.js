...
function VelocityVector () {
	if (arguments.length == 0) {	//nothing
		...
		this.y = null;
		this.z = null;
	} else if (arguments.length == 1) { // VelocityVector
...
VelocityVector.VectorTypeConstructorSurrogate = function(v) {
	return new VelocityVector(v);
};

VelocityVector.getVectorName = function() {
